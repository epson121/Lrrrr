...
<html class="no-js" lang="en">
    ...
    <div class="story"><div class="bg"></div>
        <div class="float-left">
              ...
              <p class="black-p">
                ...
                like I just did) from time to time.
              </p>
              <ul class="side-nav">
                <li><a href="http://localhost/Lrrrr/apps/ember-markdown/index.html">Markdown editor </a></li>
                <li><a href="http://citidist.lrrrr.info">City distance. Enter a city. Any city. Or two.</a></li>
  ...
  <div id="fourth">
    <div class="story">
        <div class="float-left">
            <h2>Games and graphics</h2>
              <p class="black-p">
                I am not a gamer, but I've made a few games. Also I took a computer graphics class, and it was really fun. 
                Check out the <a href="graphics.php">gallery</a>.
              </p>
              <ul class="side-nav">
                <li><a href="http://www.codeskulptor.org/#user14_wKWCSAy2CS_54.py">BlackJack</a></li>
                <li><a href="http://www.codeskulptor.org/#user13_m18WJ61w9LTWw7M_7.py">Pong (oh lord, not again..)</a></li>
                <li><a href="http://www.codeskulptor.org/#user16_u5ckQMCPoA_10.py">Asteroids clone</a></li>
                <li><a href="https://github.com/epson121/pygame.examples">Pygame examples</a></li>
              </ul>
          </div>
      </div> <!--.story-->
  </div> <!--#third-->
   ...
   <div id="fifth">
    <div class="story">
        <div class="float-left">
            <h2 style="margin-top:-2.8em;">I experiment with new technologies, and "old" ones, too</h2>
              <p class="black-p">
                So many hipster technologies, so little time. </br>
                But you can always spare some to do a little <a href="http://emberjs.com/">ember</a> or try out
   ...
   <div id="footer" style="text-align:center;color:grey;">
      ©Luka Rajčević, 2014.
   </div>
   <script src="js/jquery.js"></script>
    ...
    $(document).ready(function(){
        $('#nav').localScroll();
        $('#intro').parallax("30%", 0.4);
        $('#second').parallax("50%", 0.3);
        $('#third').parallax("30%", 0.3);
